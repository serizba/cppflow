...
namespace cppflow {
    ...
    tensor all(const tensor& input, const tensor& reduction_indices, bool keep_dims, datatype Tidx) {
    ...
    tensor angle(const tensor& input, datatype Tout) {
    ...
    tensor any(const tensor& input, const tensor& reduction_indices, bool keep_dims, datatype Tidx) {
    ...
    tensor apply_ada_max(const tensor& var, const tensor& m, const tensor& v, const tensor& beta1_power, const tensor& lr, const tensor& beta1, const tensor& beta2, const tensor& epsilon, const tensor& grad, bool use_locking) {
    ...
    tensor apply_adadelta(const tensor& var, const tensor& accum, const tensor& accum_update, const tensor& lr, const tensor& rho, const tensor& epsilon, const tensor& grad, bool use_locking) {
    ...
    tensor apply_adagrad(const tensor& var, const tensor& accum, const tensor& lr, const tensor& grad, bool use_locking, bool update_slots) {
    ...
    tensor apply_adagrad_d_a(const tensor& var, const tensor& gradient_accumulator, const tensor& gradient_squared_accumulator, const tensor& grad, const tensor& lr, const tensor& l1, const tensor& l2, const tensor& global_step, bool use_locking) {
    ...
    tensor apply_adagrad_v2(const tensor& var, const tensor& accum, const tensor& lr, const tensor& epsilon, const tensor& grad, bool use_locking, bool update_slots) {
    ...
    tensor apply_adam(const tensor& var, const tensor& m, const tensor& v, const tensor& beta1_power, const tensor& beta2_power, const tensor& lr, const tensor& beta1, const tensor& beta2, const tensor& epsilon, const tensor& grad, bool use_locking, bool use_nesterov) {
    ...
    tensor apply_add_sign(const tensor& var, const tensor& m, const tensor& lr, const tensor& alpha, const tensor& sign_decay, const tensor& beta, const tensor& grad, bool use_locking) {
    ...
    tensor apply_centered_r_m_s_prop(const tensor& var, const tensor& mg, const tensor& ms, const tensor& mom, const tensor& lr, const tensor& rho, const tensor& momentum, const tensor& epsilon, const tensor& grad, bool use_locking) {
    ...
    tensor apply_ftrl(const tensor& var, const tensor& accum, const tensor& linear, const tensor& grad, const tensor& lr, const tensor& l1, const tensor& l2, const tensor& lr_power, bool use_locking, bool multiply_linear_by_lr) {
    ...
    tensor apply_ftrl_v2(const tensor& var, const tensor& accum, const tensor& linear, const tensor& grad, const tensor& lr, const tensor& l1, const tensor& l2, const tensor& l2_shrinkage, const tensor& lr_power, bool use_locking, bool multiply_linear_by_lr) {
    ...
    tensor apply_gradient_descent(const tensor& var, const tensor& alpha, const tensor& delta, bool use_locking) {
    ...
    tensor apply_momentum(const tensor& var, const tensor& accum, const tensor& lr, const tensor& grad, const tensor& momentum, bool use_locking, bool use_nesterov) {
    ...
    tensor apply_power_sign(const tensor& var, const tensor& m, const tensor& lr, const tensor& logbase, const tensor& sign_decay, const tensor& beta, const tensor& grad, bool use_locking) {
    ...
    tensor apply_proximal_adagrad(const tensor& var, const tensor& accum, const tensor& lr, const tensor& l1, const tensor& l2, const tensor& grad, bool use_locking) {
    ...
    tensor apply_proximal_gradient_descent(const tensor& var, const tensor& alpha, const tensor& l1, const tensor& l2, const tensor& delta, bool use_locking) {
    ...
    tensor apply_r_m_s_prop(const tensor& var, const tensor& ms, const tensor& mom, const tensor& lr, const tensor& rho, const tensor& momentum, const tensor& epsilon, const tensor& grad, bool use_locking) {
    ...
    tensor approximate_equal(const tensor& x, const tensor& y, float tolerance) {
    ...
    tensor arg_max(const tensor& input, const tensor& dimension, datatype Tidx, datatype output_type) {
    ...
    tensor arg_min(const tensor& input, const tensor& dimension, datatype Tidx, datatype output_type) {
    ...
    tensor as_string(const tensor& input, int64_t precision, bool scientific, bool shortest, int64_t width, const std::string& fill) {
    ...
    tensor assign(const tensor& ref, const tensor& value, bool validate_shape, bool use_locking) {
    ...
    tensor assign_add(const tensor& ref, const tensor& value, bool use_locking) {
    ...
    tensor assign_sub(const tensor& ref, const tensor& value, bool use_locking) {
    ...
    tensor audio_spectrogram(const tensor& input, int64_t window_size, int64_t stride, bool magnitude_squared) {
    ...
    tensor audio_summary(const tensor& tag, const tensor& input_tensor, float sample_rate, int64_t max_outputs) {
    ...
    tensor audio_summary_v2(const tensor& tag, const tensor& input_tensor, const tensor& sample_rate, int64_t max_outputs) {
    ...
    tensor auto_shard_dataset(const tensor& input_dataset, const tensor& num_workers, const tensor& index, const std::vector<datatype>& output_types, const std::vector< std::vector<int64_t>>& output_shapes, int64_t auto_shard_policy) {
    ...
    tensor avg_pool(const tensor& value, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, const std::string& data_format) {
    ...
    tensor avg_pool3_d(const tensor& input, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, const std::string& data_format) {
    ...
    tensor avg_pool3_d_grad(const tensor& orig_input_shape, const tensor& grad, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, const std::string& data_format) {
    ...
    tensor avg_pool_grad(const tensor& orig_input_shape, const tensor& grad, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, const std::string& data_format) {
    ...
    tensor barrier(const std::vector<datatype>& component_types, const std::vector< std::vector<int64_t>>& shapes, int64_t capacity, const std::string& container, const std::string& shared_name) {
    ...
    tensor batch_dataset_v2(const tensor& input_dataset, const tensor& batch_size, const tensor& drop_remainder, const std::vector<datatype>& output_types, const std::vector< std::vector<int64_t>>& output_shapes, bool parallel_copy) {
    ...
    tensor batch_mat_mul(const tensor& x, const tensor& y, bool adj_x, bool adj_y) {
    ...
    tensor batch_mat_mul_v2(const tensor& x, const tensor& y, bool adj_x, bool adj_y) {
    ...
    tensor batch_matrix_inverse(const tensor& input, bool adjoint) {
    ...
    tensor batch_matrix_solve(const tensor& matrix, const tensor& rhs, bool adjoint) {
    ...
    tensor batch_matrix_solve_ls(const tensor& matrix, const tensor& rhs, const tensor& l2_regularizer, bool fast) {
    ...
    tensor batch_matrix_triangular_solve(const tensor& matrix, const tensor& rhs, bool lower, bool adjoint) {
    ...
    tensor batch_to_space(const tensor& input, const tensor& crops, int64_t block_size, datatype Tidx) {
    ...
    tensor batch_to_space_n_d(const tensor& input, const tensor& block_shape, const tensor& crops, datatype Tblock_shape, datatype Tcrops) {
    ...
    tensor bias_add(const tensor& value, const tensor& bias, const std::string& data_format) {
    ...
    tensor bias_add_grad(const tensor& out_backprop, const std::string& data_format) {
    ...
    tensor broadcast_to(const tensor& input, const tensor& shape, datatype Tidx) {
    ...
    tensor cast(const tensor& x, datatype SrcT, datatype DstT, bool Truncate) {
    ...
    tensor collective_bcast_recv(int64_t group_size, int64_t group_key, int64_t instance_key, const std::vector<int64_t>& shape, const std::string& communication_hint, float timeout_seconds) {
    ...
    tensor collective_bcast_send(const tensor& input, int64_t group_size, int64_t group_key, int64_t instance_key, const std::vector<int64_t>& shape, const std::string& communication_hint, float timeout_seconds) {
    ...
    tensor collective_gather(const tensor& input, int64_t group_size, int64_t group_key, int64_t instance_key, const std::vector<int64_t>& shape, const std::string& communication_hint, float timeout_seconds) {
    ...
    tensor collective_reduce(const tensor& input, int64_t group_size, int64_t group_key, int64_t instance_key, const std::string& merge_op, const std::string& final_op, const std::vector<int64_t>& subdiv_offsets, const std::vector<int64_t>& wait_for, const std::string& communication_hint, float timeout_seconds) {
    ...
    tensor complex(const tensor& real, const tensor& imag, datatype Tout) {
    ...
    tensor complex_abs(const tensor& x, datatype Tout) {
    ...
    tensor concat_v2(const std::vector<tensor>& values, const tensor& axis, datatype Tidx) {
    ...
    tensor conditional_accumulator(datatype dtype, const std::vector<int64_t>& shape, const std::string& container, const std::string& shared_name, const std::string& reduction_type) {
    ...
    tensor configure_distributed_t_p_u(const std::string& embedding_config, const std::string& tpu_embedding_config, bool is_global_init, bool enable_whole_mesh_compilations, bool compilation_failure_closes_chips) {
    ...
    tensor conjugate_transpose(const tensor& x, const tensor& perm, datatype Tperm) {
    ...
    tensor conv2_d(const tensor& input, const tensor& filter, const std::vector<int64_t>& strides, const std::string& padding, const std::vector<int64_t>& explicit_paddings, const std::vector<int64_t>& dilations, bool use_cudnn_on_gpu, const std::string& data_format) {
    ...
    tensor conv2_d_backprop_filter(const tensor& input, const tensor& filter_sizes, const tensor& out_backprop, const std::vector<int64_t>& strides, const std::string& padding, const std::vector<int64_t>& explicit_paddings, const std::vector<int64_t>& dilations, bool use_cudnn_on_gpu, const std::string& data_format) {
    ...
    tensor conv2_d_backprop_input(const tensor& input_sizes, const tensor& filter, const tensor& out_backprop, const std::vector<int64_t>& strides, const std::string& padding, const std::vector<int64_t>& explicit_paddings, const std::vector<int64_t>& dilations, bool use_cudnn_on_gpu, const std::string& data_format) {
    ...
    tensor conv3_d(const tensor& input, const tensor& filter, const std::vector<int64_t>& strides, const std::string& padding, const std::vector<int64_t>& dilations, const std::string& data_format) {
    ...
    tensor conv3_d_backprop_filter_v2(const tensor& input, const tensor& filter_sizes, const tensor& out_backprop, const std::vector<int64_t>& strides, const std::string& padding, const std::vector<int64_t>& dilations, const std::string& data_format) {
    ...
    tensor conv3_d_backprop_input_v2(const tensor& input_sizes, const tensor& filter, const tensor& out_backprop, const std::vector<int64_t>& strides, const std::string& padding, const std::vector<int64_t>& dilations, const std::string& data_format, datatype Tshape) {
    ...
    tensor crop_and_resize(const tensor& image, const tensor& boxes, const tensor& box_ind, const tensor& crop_size, const std::string& method, float extrapolation_value) {
    ...
    tensor crop_and_resize_grad_boxes(const tensor& grads, const tensor& image, const tensor& boxes, const tensor& box_ind, const std::string& method) {
    ...
    tensor crop_and_resize_grad_image(const tensor& grads, const tensor& boxes, const tensor& box_ind, const tensor& image_size, const std::string& method) {
    ...
    tensor cudnn_r_n_n_canonical_to_params(const tensor& num_layers, const tensor& num_units, const tensor& input_size, const std::vector<tensor>& weights, const std::vector<tensor>& biases, const std::string& rnn_mode, const std::string& input_mode, const std::string& direction, float dropout, int64_t seed, int64_t seed2) {
    ...
    tensor cudnn_r_n_n_canonical_to_params_v2(const tensor& num_layers, const tensor& num_units, const tensor& input_size, const std::vector<tensor>& weights, const std::vector<tensor>& biases, const std::string& rnn_mode, const std::string& input_mode, const std::string& direction, float dropout, int64_t seed, int64_t seed2, int64_t num_proj) {
    ...
    tensor cudnn_r_n_n_params_size(const tensor& num_layers, const tensor& num_units, const tensor& input_size, datatype S, const std::string& rnn_mode, const std::string& input_mode, const std::string& direction, float dropout, int64_t seed, int64_t seed2, int64_t num_proj) {
    ...
    tensor cumprod(const tensor& x, const tensor& axis, bool exclusive, bool reverse, datatype Tidx) {
    ...
    tensor cumsum(const tensor& x, const tensor& axis, bool exclusive, bool reverse, datatype Tidx) {
    ...
    tensor cumulative_logsumexp(const tensor& x, const tensor& axis, bool exclusive, bool reverse, datatype Tidx) {
    ...
    tensor data_format_dim_map(const tensor& x, const std::string& src_format, const std::string& dst_format) {
    ...
    tensor data_format_vec_permute(const tensor& x, const std::string& src_format, const std::string& dst_format) {
    ...
    tensor dataset_to_graph(const tensor& input_dataset, const std::vector< std::string>& stateful_whitelist, bool allow_stateful, bool strip_device_assignment) {
    ...
    tensor dataset_to_graph_v2(const tensor& input_dataset, int64_t external_state_policy, bool strip_device_assignment) {
    ...
    tensor debug_identity(const tensor& input, const std::vector< std::string>& debug_urls, const std::string& device_name, const std::string& tensor_name, bool gated_grpc) {
    ...
    tensor debug_identity_v2(const tensor& input, const std::vector< std::string>& debug_urls, const std::string& tfdbg_context_id, const std::string& op_name, int64_t output_slot, int64_t tensor_debug_mode, int64_t circular_buffer_size, const std::string& tfdbg_run_id) {
    ...
    tensor debug_nan_count(const tensor& input, const std::vector< std::string>& debug_urls, const std::string& device_name, const std::string& tensor_name, bool gated_grpc) {
    ...
    tensor debug_numeric_summary(const tensor& input, const std::vector< std::string>& debug_urls, const std::string& device_name, const std::string& tensor_name, float lower_bound, float upper_bound, bool mute_if_healthy, bool gated_grpc) {
    ...
    tensor debug_numeric_summary_v2(const tensor& input, datatype output_dtype, int64_t tensor_debug_mode, int64_t tensor_id) {
    ...
    tensor decode_and_crop_jpeg(const tensor& contents, const tensor& crop_window, int64_t channels, int64_t ratio, bool fancy_upscaling, bool try_recover_truncated, float acceptable_fraction, const std::string& dct_method) {
    ...
    tensor decode_bmp(const tensor& contents, int64_t channels) {
    ...
    tensor decode_c_s_v(const tensor& records, const std::vector<tensor>& record_defaults, const std::vector<datatype>& OUT_TYPE, const std::vector<int64_t>& select_cols, const std::string& field_delim, bool use_quote_delim, const std::string& na_value) {
        // Define Op
...
tensor decode_jpeg(const tensor& contents, int64_t channels, int64_t ratio, bool fancy_upscaling, bool try_recover_truncated, float acceptable_fraction, const std::string& dct_method) {
...
tensor decode_padded_raw(const tensor& input_bytes, const tensor& fixed_length, datatype out_type, bool little_endian) {
...
tensor decode_png(const tensor& contents, int64_t channels, datatype dtype) {
...
tensor decode_raw(const tensor& bytes, datatype out_type, bool little_endian) {
    ...
    int num_outputs_op = 1;
    TFE_TensorHandle* res[1] = { nullptr };
    TFE_Execute(op.get(), res, &num_outputs_op, cppflow::context::get_status());
    status_check(context::get_status());
    return tensor(res[0]);
}
...
tensor depth_to_space(const tensor& input, int64_t block_size, const std::string& data_format) {
...
tensor depthwise_conv2d_native(const tensor& input, const tensor& filter, const std::vector<int64_t>& strides, const std::string& padding, const std::vector<int64_t>& explicit_paddings, const std::vector<int64_t>& dilations, const std::string& data_format) {
...
tensor depthwise_conv2d_native_backprop_filter(const tensor& input, const tensor& filter_sizes, const tensor& out_backprop, const std::vector<int64_t>& strides, const std::string& padding, const std::vector<int64_t>& explicit_paddings, const std::vector<int64_t>& dilations, const std::string& data_format) {
...
tensor depthwise_conv2d_native_backprop_input(const tensor& input_sizes, const tensor& filter, const tensor& out_backprop, const std::vector<int64_t>& strides, const std::string& padding, const std::vector<int64_t>& explicit_paddings, const std::vector<int64_t>& dilations, const std::string& data_format) {
...
tensor dequantize(const tensor& input, const tensor& min_range, const tensor& max_range, const std::string& mode, bool narrow_range, int64_t axis, datatype dtype) {
...
tensor eager_py_func(const std::vector<tensor>& input, const std::string& token, const std::vector<datatype>& Tin, const std::vector<datatype>& Tout, bool is_async) {
...
tensor edit_distance(const tensor& hypothesis_indices, const tensor& hypothesis_values, const tensor& hypothesis_shape, const tensor& truth_indices, const tensor& truth_values, const tensor& truth_shape, bool normalize) {
...
tensor empty(const tensor& shape, datatype dtype, bool init) {
...
tensor encode_base64(const tensor& input, bool pad) {
...
tensor encode_jpeg(const tensor& image, const std::string& format, int64_t quality, bool progressive, bool optimize_size, bool chroma_downsampling, const std::string& density_unit, int64_t x_density, int64_t y_density, const std::string& xmp_metadata) {
...
tensor encode_png(const tensor& image, int64_t compression) {
...
tensor encode_proto(const tensor& sizes, const std::vector<tensor>& values, const std::vector< std::string>& field_names, const std::string& message_type, const std::vector<datatype>& Tinput_types, const std::string& descriptor_source) {
...
tensor enter(const tensor& data, const std::string& frame_name, bool is_constant, int64_t parallel_iterations) {
...
tensor equal(const tensor& x, const tensor& y, bool incompatible_shape_error) {
...
tensor euclidean_norm(const tensor& input, const tensor& reduction_indices, bool keep_dims, datatype Tidx) {
...
tensor expand_dims(const tensor& input, const tensor& dim, datatype Tdim) {
...
tensor experimental_auto_shard_dataset(const tensor& input_dataset, const tensor& num_workers, const tensor& index, const std::vector<datatype>& output_types, const std::vector< std::vector<int64_t>>& output_shapes, int64_t auto_shard_policy) {
...
tensor experimental_rebatch_dataset(const tensor& input_dataset, const tensor& num_replicas, const std::vector<datatype>& output_types, const std::vector< std::vector<int64_t>>& output_shapes, bool use_fallback) {
...
tensor experimental_thread_pool_handle(int64_t num_threads, const std::string& display_name, int64_t max_intra_op_parallelism, const std::string& container, const std::string& shared_name) {
...
tensor extract_glimpse(const tensor& input, const tensor& size, const tensor& offsets, bool centered, bool normalized, bool uniform_noise, const std::string& noise) {
...
tensor extract_jpeg_shape(const tensor& contents, datatype output_type) {
...
tensor f_f_t(const tensor& input, datatype Tcomplex) {
...
tensor f_f_t2_d(const tensor& input, datatype Tcomplex) {
...
tensor f_f_t3_d(const tensor& input, datatype Tcomplex) {
...
tensor f_i_f_o_queue(const std::vector<datatype>& component_types, const std::vector< std::vector<int64_t>>& shapes, int64_t capacity, const std::string& container, const std::string& shared_name) {
...
tensor f_i_f_o_queue_v2(const std::vector<datatype>& component_types, const std::vector< std::vector<int64_t>>& shapes, int64_t capacity, const std::string& container, const std::string& shared_name) {
...
tensor fake_quant_with_min_max_args(const tensor& inputs, float min, float max, int64_t num_bits, bool narrow_range) {
...
tensor fake_quant_with_min_max_args_gradient(const tensor& gradients, const tensor& inputs, float min, float max, int64_t num_bits, bool narrow_range) {
...
tensor fake_quant_with_min_max_vars(const tensor& inputs, const tensor& min, const tensor& max, int64_t num_bits, bool narrow_range) {
...
tensor fake_quant_with_min_max_vars_per_channel(const tensor& inputs, const tensor& min, const tensor& max, int64_t num_bits, bool narrow_range) {
...
tensor fill(const tensor& dims, const tensor& value, datatype index_type) {
...
tensor fixed_length_record_reader(int64_t record_bytes, int64_t header_bytes, int64_t footer_bytes, int64_t hop_bytes, const std::string& container, const std::string& shared_name) {
...
tensor fixed_length_record_reader_v2(int64_t record_bytes, int64_t header_bytes, int64_t footer_bytes, int64_t hop_bytes, const std::string& container, const std::string& shared_name, const std::string& encoding) {
...
tensor fractional_avg_pool_grad(const tensor& orig_input_input_tensor_shape, const tensor& out_backprop, const tensor& row_pooling_sequence, const tensor& col_pooling_sequence, bool overlapping) {
...
tensor fractional_max_pool_grad(const tensor& orig_input, const tensor& orig_output, const tensor& out_backprop, const tensor& row_pooling_sequence, const tensor& col_pooling_sequence, bool overlapping) {
...
tensor fused_resize_and_pad_conv2_d(const tensor& input, const tensor& size, const tensor& paddings, const tensor& filter, const std::string& mode, const std::vector<int64_t>& strides, const std::string& padding, bool resize_align_corners) {
...
tensor gather(const tensor& params, const tensor& indices, datatype Tparams, datatype Tindices, bool validate_indices) {
...
tensor gather_v2(const tensor& params, const tensor& indices, const tensor& axis, datatype Tparams, datatype Tindices, datatype Taxis, int64_t batch_dims) {
...
tensor hash_table(datatype key_dtype, datatype value_dtype, const std::string& container, const std::string& shared_name, bool use_node_name_sharing) {
...
tensor hash_table_v2(datatype key_dtype, datatype value_dtype, const std::string& container, const std::string& shared_name, bool use_node_name_sharing) {
...
tensor histogram_fixed_width(const tensor& values, const tensor& value_range, const tensor& nbins, datatype dtype) {
...
tensor i_f_f_t(const tensor& input, datatype Tcomplex) {
...
tensor i_f_f_t2_d(const tensor& input, datatype Tcomplex) {
...
tensor i_f_f_t3_d(const tensor& input, datatype Tcomplex) {
...
tensor i_r_f_f_t(const tensor& input, const tensor& fft_length, datatype Treal, datatype Tcomplex) {
...
tensor i_r_f_f_t2_d(const tensor& input, const tensor& fft_length, datatype Treal, datatype Tcomplex) {
...
tensor i_r_f_f_t3_d(const tensor& input, const tensor& fft_length, datatype Treal, datatype Tcomplex) {
...
tensor imag(const tensor& input, datatype Tout) {
...
tensor image_projective_transform_v2(const tensor& images, const tensor& transforms, const tensor& output_shape, datatype dtype, const std::string& interpolation, const std::string& fill_mode) {
...
tensor image_summary(const tensor& tag, const tensor& input_tensor, const tensor& bad_color, int64_t max_images) {
...
tensor l_r_n(const tensor& input, int64_t depth_radius, float bias, float alpha, float beta) {
...
tensor l_r_n_grad(const tensor& input_grads, const tensor& input_image, const tensor& output_image, int64_t depth_radius, float bias, float alpha, float beta) {
...
tensor leaky_relu(const tensor& features, float alpha) {
...
tensor leaky_relu_grad(const tensor& gradients, const tensor& features, float alpha) {
...
tensor lin_space(const tensor& start, const tensor& stop, const tensor& num, datatype Tidx) {
...
tensor load_and_remap_matrix(const tensor& ckpt_path, const tensor& old_input_tensor_name, const tensor& row_remapping, const tensor& col_remapping, const tensor& initializing_values, int64_t num_rows, int64_t num_cols, int64_t max_rows_in_memory) {
...
tensor lower_bound(const tensor& sorted_inputs, const tensor& values, datatype out_type) {
...
tensor map_incomplete_size(const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor map_peek(const tensor& key, const tensor& indices, const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor map_size(const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor map_unstage(const tensor& key, const tensor& indices, const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor mat_mul(const tensor& a, const tensor& b, bool transpose_a, bool transpose_b) {
...
tensor matrix_band_part(const tensor& input, const tensor& num_lower, const tensor& num_upper, datatype Tindex) {
...
tensor matrix_diag_part_v3(const tensor& input, const tensor& k, const tensor& padding_value, const std::string& align) {
...
tensor matrix_diag_v3(const tensor& diagonal, const tensor& k, const tensor& num_rows, const tensor& num_cols, const tensor& padding_value, const std::string& align) {
...
tensor matrix_inverse(const tensor& input, bool adjoint) {
...
tensor matrix_set_diag_v3(const tensor& input, const tensor& diagonal, const tensor& k, const std::string& align) {
...
tensor matrix_solve(const tensor& matrix, const tensor& rhs, bool adjoint) {
...
tensor matrix_solve_ls(const tensor& matrix, const tensor& rhs, const tensor& l2_regularizer, bool fast) {
...
tensor matrix_triangular_solve(const tensor& matrix, const tensor& rhs, bool lower, bool adjoint) {
...
tensor max(const tensor& input, const tensor& reduction_indices, bool keep_dims, datatype Tidx) {
...
tensor max_pool(const tensor& input, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, const std::string& data_format) {
...
tensor max_pool3_d(const tensor& input, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, const std::string& data_format) {
...
tensor max_pool3_d_grad(const tensor& orig_input, const tensor& orig_output, const tensor& grad, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, const std::string& data_format, datatype TInput) {
...
tensor max_pool3_d_grad_grad(const tensor& orig_input, const tensor& orig_output, const tensor& grad, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, const std::string& data_format) {
...
tensor max_pool_grad(const tensor& orig_input, const tensor& orig_output, const tensor& grad, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, const std::string& data_format) {
...
tensor max_pool_grad_grad(const tensor& orig_input, const tensor& orig_output, const tensor& grad, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, const std::string& data_format) {
...
tensor max_pool_grad_grad_v2(const tensor& orig_input, const tensor& orig_output, const tensor& grad, const tensor& ksize, const tensor& strides, const std::string& padding, const std::string& data_format) {
...
tensor max_pool_grad_grad_with_argmax(const tensor& input, const tensor& grad, const tensor& argmax, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, datatype Targmax, bool include_batch_in_index) {
...
tensor max_pool_grad_v2(const tensor& orig_input, const tensor& orig_output, const tensor& grad, const tensor& ksize, const tensor& strides, const std::string& padding, const std::string& data_format) {
...
tensor max_pool_grad_with_argmax(const tensor& input, const tensor& grad, const tensor& argmax, const std::vector<int64_t>& ksize, const std::vector<int64_t>& strides, const std::string& padding, datatype Targmax, bool include_batch_in_index) {
...
tensor max_pool_v2(const tensor& input, const tensor& ksize, const tensor& strides, const std::string& padding, const std::string& data_format) {
...
tensor mean(const tensor& input, const tensor& reduction_indices, bool keep_dims, datatype Tidx) {
...
tensor mfcc(const tensor& spectrogram, const tensor& sample_rate, float upper_frequency_limit, float lower_frequency_limit, int64_t filterbank_channel_count, int64_t dct_coefficient_count) {
...
tensor min(const tensor& input, const tensor& reduction_indices, bool keep_dims, datatype Tidx) {
...
tensor mirror_pad(const tensor& input, const tensor& paddings, const std::string& mode, datatype Tpaddings) {
...
tensor mirror_pad_grad(const tensor& input, const tensor& paddings, const std::string& mode, datatype Tpaddings) {
...
tensor model_dataset(const tensor& input_dataset, const std::vector<datatype>& output_types, const std::vector< std::vector<int64_t>>& output_shapes, int64_t algorithm, int64_t cpu_budget) {
...
tensor multinomial(const tensor& logits, const tensor& num_samples, int64_t seed, int64_t seed2, datatype output_dtype) {
...
tensor mutable_dense_hash_table(const tensor& empty_key, datatype key_dtype, datatype value_dtype, const std::vector<int64_t>& value_shape, const std::string& container, const std::string& shared_name, bool use_node_name_sharing, int64_t initial_num_buckets, float max_load_factor) {
...
tensor mutable_dense_hash_table_v2(const tensor& empty_key, const tensor& deleted_key, datatype key_dtype, datatype value_dtype, const std::vector<int64_t>& value_shape, const std::string& container, const std::string& shared_name, bool use_node_name_sharing, int64_t initial_num_buckets, float max_load_factor) {
...
tensor mutable_hash_table(datatype key_dtype, datatype value_dtype, const std::string& container, const std::string& shared_name, bool use_node_name_sharing) {
...
tensor mutable_hash_table_of_tensors(datatype key_dtype, datatype value_dtype, const std::vector<int64_t>& value_shape, const std::string& container, const std::string& shared_name, bool use_node_name_sharing) {
...
tensor mutable_hash_table_of_tensors_v2(datatype key_dtype, datatype value_dtype, const std::vector<int64_t>& value_shape, const std::string& container, const std::string& shared_name, bool use_node_name_sharing) {
...
tensor mutable_hash_table_v2(datatype key_dtype, datatype value_dtype, const std::string& container, const std::string& shared_name, bool use_node_name_sharing) {
...
tensor non_deterministic_ints(const tensor& shape, datatype dtype, datatype shape_dtype) {
...
tensor non_max_suppression(const tensor& boxes, const tensor& scores, const tensor& max_output_size, float iou_threshold) {
...
tensor non_max_suppression_v2(const tensor& boxes, const tensor& scores, const tensor& max_output_size, const tensor& iou_threshold, datatype T_threshold) {
...
tensor non_max_suppression_v3(const tensor& boxes, const tensor& scores, const tensor& max_output_size, const tensor& iou_threshold, const tensor& score_threshold, datatype T_threshold) {
...
tensor not_equal(const tensor& x, const tensor& y, bool incompatible_shape_error) {
...
tensor nth_element(const tensor& input, const tensor& n, bool reverse) {
...
tensor one_hot(const tensor& indices, const tensor& depth, const tensor& on_value, const tensor& off_value, int64_t axis, datatype TI) {
...
tensor ordered_map_incomplete_size(const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor ordered_map_peek(const tensor& key, const tensor& indices, const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor ordered_map_size(const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor ordered_map_unstage(const tensor& key, const tensor& indices, const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor outfeed_dequeue(datatype dtype, const std::vector<int64_t>& shape, int64_t device_ordinal) {
...
tensor outfeed_dequeue_tuple(const std::vector<datatype>& dtypes, const std::vector< std::vector<int64_t>>& shapes, int64_t device_ordinal) {
...
tensor pack(const std::vector<tensor>& values, int64_t axis) {
...
tensor pad(const tensor& input, const tensor& paddings, datatype Tpaddings) {
...
tensor pad_v2(const tensor& input, const tensor& paddings, const tensor& constant_values, datatype Tpaddings) {
...
tensor padded_batch_dataset_v2(const tensor& input_dataset, const tensor& batch_size, const std::vector<tensor>& padded_shapes, const std::vector<tensor>& padding_values, const tensor& drop_remainder, const std::vector<datatype>& Toutput_types, const std::vector< std::vector<int64_t>>& output_shapes, bool parallel_copy) {
...
tensor padding_f_i_f_o_queue(const std::vector<datatype>& component_types, const std::vector< std::vector<int64_t>>& shapes, int64_t capacity, const std::string& container, const std::string& shared_name) {
...
tensor padding_f_i_f_o_queue_v2(const std::vector<datatype>& component_types, const std::vector< std::vector<int64_t>>& shapes, int64_t capacity, const std::string& container, const std::string& shared_name) {
...
tensor parameterized_truncated_normal(const tensor& shape, const tensor& means, const tensor& stdevs, const tensor& minvals, const tensor& maxvals, datatype dtype, int64_t seed, int64_t seed2) {
...
tensor prefetch_dataset(const tensor& input_dataset, const tensor& buffer_size, const std::vector<datatype>& output_types, const std::vector< std::vector<int64_t>>& output_shapes, int64_t slack_period, bool legacy_autotune) {
...
tensor print(const tensor& input, const std::vector<tensor>& data, const std::vector<datatype>& U, const std::string& message, int64_t first_n, int64_t summarize) {
...
tensor priority_queue(const std::vector<datatype>& component_types, const std::vector< std::vector<int64_t>>& shapes, int64_t capacity, const std::string& container, const std::string& shared_name) {
...
tensor priority_queue_v2(const std::vector<datatype>& component_types, const std::vector< std::vector<int64_t>>& shapes, int64_t capacity, const std::string& container, const std::string& shared_name) {
...
tensor prod(const tensor& input, const tensor& reduction_indices, bool keep_dims, datatype Tidx) {
...
tensor quantize_and_dequantize(const tensor& input, bool signed_input, int64_t num_bits, bool range_given, float input_min, float input_max) {
...
tensor quantize_and_dequantize_v2(const tensor& input, const tensor& input_min, const tensor& input_max, bool signed_input, int64_t num_bits, bool range_given, const std::string& round_mode, bool narrow_range, int64_t axis) {
...
tensor quantize_and_dequantize_v3(const tensor& input, const tensor& input_min, const tensor& input_max, const tensor& num_bits, bool signed_input, bool range_given, bool narrow_range, int64_t axis) {
...
tensor queue_dequeue(const tensor& handle, const std::vector<datatype>& component_types, int64_t timeout_ms) {
...
tensor queue_dequeue_many(const tensor& handle, const tensor& n, const std::vector<datatype>& component_types, int64_t timeout_ms) {
...
tensor queue_dequeue_many_v2(const tensor& handle, const tensor& n, const std::vector<datatype>& component_types, int64_t timeout_ms) {
...
tensor queue_dequeue_up_to(const tensor& handle, const tensor& n, const std::vector<datatype>& component_types, int64_t timeout_ms) {
...
tensor queue_dequeue_up_to_v2(const tensor& handle, const tensor& n, const std::vector<datatype>& component_types, int64_t timeout_ms) {
...
tensor queue_dequeue_v2(const tensor& handle, const std::vector<datatype>& component_types, int64_t timeout_ms) {
...
tensor r_f_f_t(const tensor& input, const tensor& fft_length, datatype Treal, datatype Tcomplex) {
...
tensor r_f_f_t2_d(const tensor& input, const tensor& fft_length, datatype Treal, datatype Tcomplex) {
...
tensor r_f_f_t3_d(const tensor& input, const tensor& fft_length, datatype Treal, datatype Tcomplex) {
...
tensor ragged_tensor_to_variant(const std::vector<tensor>& rt_nested_splits, const tensor& rt_dense_values, datatype Tvalues, bool batched_input, datatype Tsplits) {
...
tensor random_crop(const tensor& image, const tensor& size, int64_t seed, int64_t seed2) {
...
tensor random_gamma(const tensor& shape, const tensor& alpha, datatype S, int64_t seed, int64_t seed2) {
...
tensor random_poisson(const tensor& shape, const tensor& rate, datatype S, datatype dtype, int64_t seed, int64_t seed2) {
...
tensor random_poisson_v2(const tensor& shape, const tensor& rate, datatype S, int64_t seed, int64_t seed2, datatype R, datatype dtype) {
...
tensor random_shuffle(const tensor& value, int64_t seed, int64_t seed2) {
...
tensor random_shuffle_queue(const std::vector<datatype>& component_types, const std::vector< std::vector<int64_t>>& shapes, int64_t capacity, int64_t min_after_dequeue, int64_t seed, int64_t seed2, const std::string& container, const std::string& shared_name) {
...
tensor random_shuffle_queue_v2(const std::vector<datatype>& component_types, const std::vector< std::vector<int64_t>>& shapes, int64_t capacity, int64_t min_after_dequeue, int64_t seed, int64_t seed2, const std::string& container, const std::string& shared_name) {
...
tensor random_standard_normal(const tensor& shape, datatype dtype, int64_t seed, int64_t seed2) {
...
tensor random_uniform(const tensor& shape, datatype dtype, int64_t seed, int64_t seed2) {
...
tensor random_uniform_int(const tensor& shape, const tensor& minval, const tensor& maxval, datatype Tout, int64_t seed, int64_t seed2) {
...
tensor range(const tensor& start, const tensor& limit, const tensor& delta, datatype Tidx) {
...
tensor real(const tensor& input, datatype Tout) {
...
tensor rebatch_dataset(const tensor& input_dataset, const tensor& num_replicas, const std::vector<datatype>& output_types, const std::vector< std::vector<int64_t>>& output_shapes, bool use_fallback) {
...
tensor record_input(const std::string& file_pattern, int64_t file_random_seed, float file_shuffle_shift_ratio, int64_t file_buffer_size, int64_t file_parallelism, int64_t batch_size, const std::string& compression_type) {
...
tensor recv(datatype tensor_type, const std::string& tensor_name, const std::string& send_device, int64_t send_device_incarnation, const std::string& recv_device, bool client_terminated) {
...
tensor reduce_join(const tensor& inputs, const tensor& reduction_indices, bool keep_dims, const std::string& separator) {
...
tensor ref_enter(const tensor& data, const std::string& frame_name, bool is_constant, int64_t parallel_iterations) {
...
tensor regex_replace(const tensor& input, const tensor& pattern, const tensor& rewrite, bool replace_global) {
...
tensor reshape(const tensor& input_tensor, const tensor& shape, datatype Tshape) {
...
tensor resize_area(const tensor& images, const tensor& size, bool align_corners) {
...
tensor resize_bicubic(const tensor& images, const tensor& size, bool align_corners, bool half_pixel_centers) {
...
tensor resize_bicubic_grad(const tensor& grads, const tensor& original_image, bool align_corners, bool half_pixel_centers) {
...
tensor resize_bilinear(const tensor& images, const tensor& size, bool align_corners, bool half_pixel_centers) {
...
tensor resize_bilinear_grad(const tensor& grads, const tensor& original_image, bool align_corners, bool half_pixel_centers) {
...
tensor resize_nearest_neighbor(const tensor& images, const tensor& size, bool align_corners, bool half_pixel_centers) {
...
tensor resize_nearest_neighbor_grad(const tensor& grads, const tensor& size, bool align_corners, bool half_pixel_centers) {
...
tensor resource_conditional_accumulator(datatype dtype, const std::vector<int64_t>& shape, const std::string& container, const std::string& shared_name, const std::string& reduction_type) {
...
tensor resource_gather(const tensor& resource, const tensor& indices, datatype dtype, datatype Tindices, int64_t batch_dims, bool validate_indices) {
...
tensor restore(const tensor& file_pattern, const tensor& input_tensor_name, datatype dt, int64_t preferred_shard) {
...
tensor restore_slice(const tensor& file_pattern, const tensor& input_tensor_name, const tensor& shape_and_slice, datatype dt, int64_t preferred_shard) {
...
tensor retrieve_t_p_u_embedding_stochastic_gradient_descent_parameters(int64_t num_shards, int64_t shard_id, int64_t table_id, const std::string& table_name, const std::string& config) {
...
tensor reverse_sequence(const tensor& input, const tensor& seq_lengths, int64_t seq_dim, int64_t batch_dim, datatype Tlen) {
...
tensor reverse_v2(const tensor& input_tensor, const tensor& axis, datatype Tidx) {
...
tensor scale_and_translate(const tensor& images, const tensor& size, const tensor& scale, const tensor& translation, const std::string& kernel_type, bool antialias) {
...
tensor scale_and_translate_grad(const tensor& grads, const tensor& original_image, const tensor& scale, const tensor& translation, const std::string& kernel_type, bool antialias) {
...
tensor scatter_add(const tensor& ref, const tensor& indices, const tensor& updates, datatype Tindices, bool use_locking) {
...
tensor scatter_div(const tensor& ref, const tensor& indices, const tensor& updates, datatype Tindices, bool use_locking) {
...
tensor scatter_max(const tensor& ref, const tensor& indices, const tensor& updates, datatype Tindices, bool use_locking) {
...
tensor scatter_min(const tensor& ref, const tensor& indices, const tensor& updates, datatype Tindices, bool use_locking) {
...
tensor scatter_mul(const tensor& ref, const tensor& indices, const tensor& updates, datatype Tindices, bool use_locking) {
...
tensor scatter_nd_add(const tensor& ref, const tensor& indices, const tensor& updates, datatype Tindices, bool use_locking) {
...
tensor scatter_nd_sub(const tensor& ref, const tensor& indices, const tensor& updates, datatype Tindices, bool use_locking) {
...
tensor scatter_nd_update(const tensor& ref, const tensor& indices, const tensor& updates, datatype Tindices, bool use_locking) {
...
tensor scatter_sub(const tensor& ref, const tensor& indices, const tensor& updates, datatype Tindices, bool use_locking) {
...
tensor scatter_update(const tensor& ref, const tensor& indices, const tensor& updates, datatype Tindices, bool use_locking) {
...
tensor serialize_iterator(const tensor& resource_handle, int64_t external_state_policy) {
...
tensor serialize_many_sparse(const tensor& sparse_indices, const tensor& sparse_values, const tensor& sparse_shape, datatype out_type) {
...
tensor serialize_sparse(const tensor& sparse_indices, const tensor& sparse_values, const tensor& sparse_shape, datatype out_type) {
...
tensor set_size(const tensor& set_indices, const tensor& set_values, const tensor& set_shape, bool validate_indices) {
...
tensor shape(const tensor& input, datatype out_type) {
...
tensor shape_n(const std::vector<tensor>& input, datatype out_type) {
...
tensor shard_dataset(const tensor& input_dataset, const tensor& num_shards, const tensor& index, const std::vector<datatype>& output_types, const std::vector< std::vector<int64_t>>& output_shapes, bool require_non_empty) {
...
tensor shuffle_and_repeat_dataset(const tensor& input_dataset, const tensor& buffer_size, const tensor& seed, const tensor& seed2, const tensor& count, const std::vector<datatype>& output_types, const std::vector< std::vector<int64_t>>& output_shapes, bool reshuffle_each_iteration) {
...
tensor shuffle_dataset(const tensor& input_dataset, const tensor& buffer_size, const tensor& seed, const tensor& seed2, const std::vector<datatype>& output_types, const std::vector< std::vector<int64_t>>& output_shapes, bool reshuffle_each_iteration) {
...
tensor size(const tensor& input, datatype out_type) {
...
tensor sobol_sample(const tensor& dim, const tensor& num_results, const tensor& skip, datatype dtype) {
...
tensor space_to_batch(const tensor& input, const tensor& paddings, int64_t block_size, datatype Tpaddings) {
...
tensor space_to_batch_n_d(const tensor& input, const tensor& block_shape, const tensor& paddings, datatype Tblock_shape, datatype Tpaddings) {
...
tensor space_to_depth(const tensor& input, int64_t block_size, const std::string& data_format) {
...
tensor sparse_apply_adadelta(const tensor& var, const tensor& accum, const tensor& accum_update, const tensor& lr, const tensor& rho, const tensor& epsilon, const tensor& grad, const tensor& indices, datatype Tindices, bool use_locking) {
...
tensor sparse_apply_adagrad(const tensor& var, const tensor& accum, const tensor& lr, const tensor& grad, const tensor& indices, datatype Tindices, bool use_locking, bool update_slots) {
...
tensor sparse_apply_adagrad_d_a(const tensor& var, const tensor& gradient_accumulator, const tensor& gradient_squared_accumulator, const tensor& grad, const tensor& indices, const tensor& lr, const tensor& l1, const tensor& l2, const tensor& global_step, datatype Tindices, bool use_locking) {
...
tensor sparse_apply_adagrad_v2(const tensor& var, const tensor& accum, const tensor& lr, const tensor& epsilon, const tensor& grad, const tensor& indices, datatype Tindices, bool use_locking, bool update_slots) {
...
tensor sparse_apply_centered_r_m_s_prop(const tensor& var, const tensor& mg, const tensor& ms, const tensor& mom, const tensor& lr, const tensor& rho, const tensor& momentum, const tensor& epsilon, const tensor& grad, const tensor& indices, datatype Tindices, bool use_locking) {
...
tensor sparse_apply_ftrl(const tensor& var, const tensor& accum, const tensor& linear, const tensor& grad, const tensor& indices, const tensor& lr, const tensor& l1, const tensor& l2, const tensor& lr_power, datatype Tindices, bool use_locking, bool multiply_linear_by_lr) {
...
tensor sparse_apply_ftrl_v2(const tensor& var, const tensor& accum, const tensor& linear, const tensor& grad, const tensor& indices, const tensor& lr, const tensor& l1, const tensor& l2, const tensor& l2_shrinkage, const tensor& lr_power, datatype Tindices, bool use_locking, bool multiply_linear_by_lr) {
...
tensor sparse_apply_momentum(const tensor& var, const tensor& accum, const tensor& lr, const tensor& grad, const tensor& indices, const tensor& momentum, datatype Tindices, bool use_locking, bool use_nesterov) {
...
tensor sparse_apply_proximal_adagrad(const tensor& var, const tensor& accum, const tensor& lr, const tensor& l1, const tensor& l2, const tensor& grad, const tensor& indices, datatype Tindices, bool use_locking) {
...
tensor sparse_apply_proximal_gradient_descent(const tensor& var, const tensor& alpha, const tensor& l1, const tensor& l2, const tensor& grad, const tensor& indices, datatype Tindices, bool use_locking) {
...
tensor sparse_apply_r_m_s_prop(const tensor& var, const tensor& ms, const tensor& mom, const tensor& lr, const tensor& rho, const tensor& momentum, const tensor& epsilon, const tensor& grad, const tensor& indices, datatype Tindices, bool use_locking) {
...
tensor sparse_conditional_accumulator(datatype dtype, const std::vector<int64_t>& shape, const std::string& container, const std::string& shared_name, const std::string& reduction_type) {
...
tensor sparse_mat_mul(const tensor& a, const tensor& b, bool transpose_a, bool transpose_b, bool a_is_sparse, bool b_is_sparse, datatype Ta, datatype Tb) {
...
tensor sparse_matrix_mat_mul(const tensor& a, const tensor& b, bool transpose_a, bool transpose_b, bool adjoint_a, bool adjoint_b, bool transpose_output, bool conjugate_output) {
...
tensor sparse_matrix_sparse_mat_mul(const tensor& a, const tensor& b, datatype type, bool transpose_a, bool transpose_b, bool adjoint_a, bool adjoint_b) {
...
tensor sparse_matrix_transpose(const tensor& input, datatype type, bool conjugate) {
...
tensor sparse_reduce_max(const tensor& input_indices, const tensor& input_values, const tensor& input_shape, const tensor& reduction_axes, bool keep_dims) {
...
tensor sparse_reduce_sum(const tensor& input_indices, const tensor& input_values, const tensor& input_shape, const tensor& reduction_axes, bool keep_dims) {
...
tensor sparse_segment_mean(const tensor& data, const tensor& indices, const tensor& segment_ids, datatype Tidx, datatype Tsegmentids) {
...
tensor sparse_segment_mean_grad(const tensor& grad, const tensor& indices, const tensor& segment_ids, const tensor& output_dim0, datatype Tidx, datatype Tsegmentids) {
...
tensor sparse_segment_mean_with_num_segments(const tensor& data, const tensor& indices, const tensor& segment_ids, const tensor& num_segments, datatype Tidx, datatype Tnumsegments, datatype Tsegmentids) {
...
tensor sparse_segment_sqrt_n(const tensor& data, const tensor& indices, const tensor& segment_ids, datatype Tidx, datatype Tsegmentids) {
...
tensor sparse_segment_sqrt_n_grad(const tensor& grad, const tensor& indices, const tensor& segment_ids, const tensor& output_dim0, datatype Tidx, datatype Tsegmentids) {
...
tensor sparse_segment_sqrt_n_with_num_segments(const tensor& data, const tensor& indices, const tensor& segment_ids, const tensor& num_segments, datatype Tidx, datatype Tnumsegments, datatype Tsegmentids) {
...
tensor sparse_segment_sum(const tensor& data, const tensor& indices, const tensor& segment_ids, datatype Tidx, datatype Tsegmentids) {
...
tensor sparse_segment_sum_with_num_segments(const tensor& data, const tensor& indices, const tensor& segment_ids, const tensor& num_segments, datatype Tidx, datatype Tnumsegments, datatype Tsegmentids) {
...
tensor sparse_tensor_dense_mat_mul(const tensor& a_indices, const tensor& a_values, const tensor& a_shape, const tensor& b, datatype Tindices, bool adjoint_a, bool adjoint_b) {
...
tensor sparse_to_dense(const tensor& sparse_indices, const tensor& output_shape, const tensor& sparse_values, const tensor& default_value, datatype Tindices, bool validate_indices) {
...
tensor split_v(const tensor& value, const tensor& size_splits, const tensor& split_dim, int64_t num_split, datatype Tlen) {
...
tensor stack_push(const tensor& handle, const tensor& elem, bool swap_memory) {
...
tensor stack_push_v2(const tensor& handle, const tensor& elem, bool swap_memory) {
...
tensor stage_peek(const tensor& index, const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor stage_size(const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor stateful_random_binomial(const tensor& resource, const tensor& algorithm, const tensor& shape, const tensor& counts, const tensor& probs, datatype S, datatype dtype) {
...
tensor stateful_standard_normal(const tensor& resource, const tensor& shape, datatype dtype, datatype shape_dtype) {
...
tensor stateful_standard_normal_v2(const tensor& resource, const tensor& algorithm, const tensor& shape, datatype dtype, datatype shape_dtype) {
...
tensor stateful_truncated_normal(const tensor& resource, const tensor& algorithm, const tensor& shape, datatype dtype, datatype shape_dtype) {
...
tensor stateful_uniform(const tensor& resource, const tensor& algorithm, const tensor& shape, datatype dtype, datatype shape_dtype) {
...
tensor stateful_uniform_full_int(const tensor& resource, const tensor& algorithm, const tensor& shape, datatype dtype, datatype shape_dtype) {
...
tensor stateful_uniform_int(const tensor& resource, const tensor& algorithm, const tensor& shape, const tensor& minval, const tensor& maxval, datatype dtype, datatype shape_dtype) {
...
tensor stateless_multinomial(const tensor& logits, const tensor& num_samples, const tensor& seed, datatype Tseed, datatype output_dtype) {
...
tensor stateless_random_binomial(const tensor& shape, const tensor& seed, const tensor& counts, const tensor& probs, datatype S, datatype Tseed, datatype dtype) {
...
tensor stateless_random_gamma_v2(const tensor& shape, const tensor& seed, const tensor& alpha, datatype dtype, datatype Tseed) {
...
tensor stateless_random_normal(const tensor& shape, const tensor& seed, datatype dtype, datatype Tseed) {
...
tensor stateless_random_poisson(const tensor& shape, const tensor& seed, const tensor& lam, datatype Rtype, datatype dtype, datatype Tseed) {
...
tensor stateless_random_uniform(const tensor& shape, const tensor& seed, datatype dtype, datatype Tseed) {
...
tensor stateless_random_uniform_full_int(const tensor& shape, const tensor& seed, datatype dtype, datatype Tseed) {
...
tensor stateless_random_uniform_int(const tensor& shape, const tensor& seed, const tensor& minval, const tensor& maxval, datatype dtype, datatype Tseed) {
...
tensor stateless_truncated_normal(const tensor& shape, const tensor& seed, datatype dtype, datatype Tseed) {
...
tensor static_regex_replace(const tensor& input, const std::string& pattern, const std::string& rewrite, bool replace_global) {
...
tensor strided_slice(const tensor& input, const tensor& begin, const tensor& end, const tensor& strides, datatype Index, int64_t begin_mask, int64_t end_mask, int64_t ellipsis_mask, int64_t new_axis_mask, int64_t shrink_axis_mask) {
...
tensor strided_slice_assign(const tensor& ref, const tensor& begin, const tensor& end, const tensor& strides, const tensor& value, datatype Index, int64_t begin_mask, int64_t end_mask, int64_t ellipsis_mask, int64_t new_axis_mask, int64_t shrink_axis_mask) {
...
tensor strided_slice_grad(const tensor& shape, const tensor& begin, const tensor& end, const tensor& strides, const tensor& dy, datatype Index, int64_t begin_mask, int64_t end_mask, int64_t ellipsis_mask, int64_t new_axis_mask, int64_t shrink_axis_mask) {
...
tensor string_format(const std::vector<tensor>& inputs, const std::string& template_arg, const std::string& placeholder, int64_t summarize) {
...
tensor string_length(const tensor& input, const std::string& unit) {
...
tensor string_to_number(const tensor& string_input_tensor, datatype out_type) {
...
tensor substr(const tensor& input, const tensor& pos, const tensor& len, const std::string& unit) {
...
tensor sum(const tensor& input, const tensor& reduction_indices, bool keep_dims, datatype Tidx) {
...
tensor t_p_u_replicated_input(const std::vector<tensor>& inputs, bool is_mirrored_variable, int64_t index, bool is_packed) {
...
tensor tensor_array(const tensor& size, datatype dtype, const std::vector<int64_t>& element_shape, bool dynamic_size, bool clear_after_read, const std::string& tensor_array_name) {
...
tensor tensor_array_v2(const tensor& size, datatype dtype, const std::vector<int64_t>& element_shape, bool dynamic_size, bool clear_after_read, const std::string& tensor_array_name) {
...
tensor tensor_list_stack(const tensor& input_handle, const tensor& element_shape, datatype element_dtype, int64_t num_elements) {
...
tensor tensor_strided_slice_update(const tensor& input, const tensor& begin, const tensor& end, const tensor& strides, const tensor& value, datatype Index, int64_t begin_mask, int64_t end_mask, int64_t ellipsis_mask, int64_t new_axis_mask, int64_t shrink_axis_mask) {
...
tensor text_line_reader(int64_t skip_header_lines, const std::string& container, const std::string& shared_name) {
...
tensor text_line_reader_v2(int64_t skip_header_lines, const std::string& container, const std::string& shared_name) {
...
tensor thread_pool_handle(int64_t num_threads, const std::string& display_name, int64_t max_intra_op_parallelism, const std::string& container, const std::string& shared_name) {
...
tensor tile(const tensor& input, const tensor& multiples, datatype Tmultiples) {
...
tensor transpose(const tensor& x, const tensor& perm, datatype Tperm) {
...
tensor tridiagonal_solve(const tensor& diagonals, const tensor& rhs, bool partial_pivoting) {
...
tensor truncated_normal(const tensor& shape, datatype dtype, int64_t seed, int64_t seed2) {
...
tensor unicode_encode(const tensor& input_values, const tensor& input_splits, const std::string& output_encoding, const std::string& errors, int64_t replacement_char, datatype Tsplits) {
...
tensor unicode_transcode(const tensor& input, const std::string& input_encoding, const std::string& output_encoding, const std::string& errors, int64_t replacement_char, bool replace_control_characters) {
...
tensor unpack(const tensor& value, int64_t num, int64_t axis) {
...
tensor unravel_index(const tensor& indices, const tensor& dims, datatype Tidx) {
...
tensor unsorted_segment_join(const tensor& inputs, const tensor& segment_ids, const tensor& num_segments, datatype Tindices, const std::string& separator, datatype Tnumsegments) {
...
tensor unsorted_segment_max(const tensor& data, const tensor& segment_ids, const tensor& num_segments, datatype Tindices, datatype Tnumsegments) {
...
tensor unsorted_segment_min(const tensor& data, const tensor& segment_ids, const tensor& num_segments, datatype Tindices, datatype Tnumsegments) {
...
tensor unsorted_segment_prod(const tensor& data, const tensor& segment_ids, const tensor& num_segments, datatype Tindices, datatype Tnumsegments) {
...
tensor unsorted_segment_sum(const tensor& data, const tensor& segment_ids, const tensor& num_segments, datatype Tindices, datatype Tnumsegments) {
...
tensor unstage(const std::vector<datatype>& dtypes, int64_t capacity, int64_t memory_limit, const std::string& container, const std::string& shared_name) {
...
tensor upper_bound(const tensor& sorted_inputs, const tensor& values, datatype out_type) {
...
tensor variable_shape(const tensor& input, datatype out_type) {
