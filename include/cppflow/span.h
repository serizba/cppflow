...
#   define TCB_SPAN_USE_STD_SPAN
#endif

#ifdef TCB_SPAN_USE_STD_SPAN
#pragma message("use c++20 span")
#include <span>
#else
#pragma message("use self defined span")
namespace std {
    template <typename ElementType, std::size_t Extent = cppflow::dynamic_extent>
